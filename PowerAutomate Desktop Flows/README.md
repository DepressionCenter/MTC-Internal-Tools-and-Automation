...
# PowerAutomate Desktop Flows

## Description
This directory contains Power Automate Desktop flows for various uses cases, such as getting MCommunity Group Memberships.
...
+ For the most part, you can copy & past the code from each /src sub-directory into Power Automate Desktop, and the application will convert the text into shapes upon pasting.
